      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 md:pt-36">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 items-start">
          <div className="space-y-10">
            ...
            <div className="rounded-[28px] border border-aaag-blue/15 bg-gradient-to-br from-white via-white to-aaag-blue/5 p-6 md:p-8 shadow-[0_25px_50px_rgba(15,23,42,0.12)]">
          ...
          <div className="rounded-3xl border border-aaag-blue/10 bg-white/80 p-6 md:p-8 shadow-xl mt-12 lg:mt-28">
